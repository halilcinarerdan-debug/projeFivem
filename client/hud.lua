...
local function OpenBlackMarketAmmo()
    ...
    for _, a in ipairs(Config.BlackMarket and Config.BlackMarket.Ammo or {}) do
        options[#options + 1] = {
            ...
            icon        = 'box',
            onSelect    = function() TriggerServerEvent('matrix:server:blackmarket:buyAmmo', a.id) end
        }
    end
...
-- gore) -- RNG YOK.
local STREET_NPC_MODELS = { `a_m_y_hipster_01`, `a_m_m_skidrow_01`, `a_f_y_runner_01` }
