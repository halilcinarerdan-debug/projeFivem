...
-- ---------------------------------------------------------------------
-- [U3] GERÇEKÇİ BALİSTİK SABİTLEME — Namlu Atış Ömrü + Mekanik Tutukluk
--
-- ★ NOT (karışıklığı önlemek için): Config.Forensics.WeaponJamChanceThreshold/
-- WeaponJamBaseChance/WeaponJamHardDeleteRisk (yukarıda, Katman 5 v1)
-- YALNIZCA adli/kalıcı-ölüm risk DEĞERİ üreten Matrix.Forensics.
-- ComputeJamChance/GetHardDeleteRiskIfJammed formülüne aittir — bu ESKİ
-- sistem AYNEN korunuyor (kanıt satırlarında hâlâ raporlanır).
--
-- Aşağıdaki "Mechanical*" alanları ise TAMAMEN AYRI, YENİ bir gerçek-zamanlı
-- oynanış mekaniğine aittir: her atışta silahın CANI gerçek namlu atış
-- ömründen (WeaponShotLifespan) düşürülür ve can %40'ın altına indiğinde
-- Jam_Probability = (1.0 - (Durability/40))^3 * 0.35 formülüyle bir
-- tutukluk OLASILIK DEĞERİ üretilir. "0 RNG" prensibi gereği bu olasılık
-- klasik bir zar atışına DEĞİL, deterministik bir biriktiriciye (accumulator)
-- eklenir — biriktirici 1.0'i geçtiği AN tutukluk kesin olarak tetiklenir
-- (bkz. server/forensics.lua Matrix.Forensics.OnWeaponShotFired). Aynı atış
-- dizisi HER ZAMAN aynı tutukluk anını üretir.
-- ---------------------------------------------------------------------
